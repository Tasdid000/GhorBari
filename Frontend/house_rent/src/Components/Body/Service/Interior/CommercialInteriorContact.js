...
import { baseUrl5 } from '../../../../redux/baseUrl'
import "./style.css"
...
const mapDispatchToProps = dispatch => {
    return {
        resetFeedbackForm: () => {
            dispatch(actions.reset('CommercialInteriorContact'))
        }
    }
}
...
class CommercialInteriorContact extends Component {
    state = {
        alertShow: false,
        alertText: null,
        alertType: null
    ...
    handleSubmit = values => {
        //console.log(values);
        axios.post(baseUrl5 + "CommercialInteriorContact", values)
            ...
            <div className="">
                <div className="container">
                    <div className="" style={{}}>
                        ...
                        <Form method="post" model="CommercialInteriorContact" onSubmit={values => this.handleSubmit(values)}>
                            <FormGroup>
                                <Row>
                                    <Col md="4">
...
export default connect(null, mapDispatchToProps)(CommercialInteriorContact);
