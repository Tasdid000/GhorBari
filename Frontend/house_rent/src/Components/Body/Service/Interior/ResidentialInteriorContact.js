...
const mapDispatchToProps = dispatch => {
    return {
        resetFeedbackForm: () => {
            dispatch(actions.reset('ResidentialinteriorContact'))
        }
    }
}
...
class ResidentialInteriorContact extends Component {
    ...
    handleSubmit = values => {
        //console.log(values);
        axios.post(baseUrl4 + "ResidentialinteriorContact", values)
            ...
            <div className="">
                <div className="container">
                    <div className="" style={{}}>
                        ...
                        <Form method="post" model="ResidentialinteriorContact" onSubmit={values => this.handleSubmit(values)}>
                            <FormGroup>
                                <Row>
                                    <Col md="4">
