        ...
        <div className='registrationbackground'>
            <Row>
                <Col md="5" className='container mx-4'>
                    <img src='/assets/images/undraw_mobile_login_re_9ntv.svg'
                ...
                <Col md="6">
                    <div style={{ paddingTop: "0%" }}>
                        {emailExistsError && (
                            <Alert color="danger" style={{ fontSize: "30px", background: "black" }}>
                                Email address already exists. Please use a different email.
                            </Alert>

                        )}
                        {registrationError && (
                            <div className="alert alert-danger" role="alert" style={{ marginTop: "10%", fontSize: "30px" }}>
                                {registrationError}
                            </div>
                        )}
                    </div>
                    <div className='registration-form'>
                        ...
                        <Row className='container'>
                            <Col md="5">
                                <button className='button10' style={{ marginTop: "5%" }} onClick={handleRegister}>Register</button>
                            </Col>
                            <Col md="7">
                                <p style={{ textAlign: "center", fontSize: "13px", paddingTop: "10%" }}>Have an account. <a href='/login' style={{ textDecoration: "none", color: "#6053fc" }}>Sign In</a></p>
                            </Col>
                        </Row>
                    </div>
                </Col>
