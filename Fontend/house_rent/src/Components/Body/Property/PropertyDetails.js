                                    ...
                                    <Col md="3">
                                        <div>
                                            <Link to={`/book-viewing/${propertyId}`}>
                                                <button className='buttonbook'><i className="fa-regular fa-calendar-days"></i> Book schedule</button>
                                            </Link>
                                ...
                                <CardBody className='container'>
                                    ...
                                    <Row style={{ marginTop: "5%" }}>
                                        ...
                                        <Col md="6" style={{ textAlign: "center" }}>
                                            <a href={`tel:${property.userphone_Number}`} className="callnow"><button className="button30" style={{ fontSize: "15px", fontWeight: "400" }}> <i class="fa-solid fa-phone"></i> Call</button></a>
                                        </Col>
                                    </Row>
                                </CardBody>
                            </Card>
