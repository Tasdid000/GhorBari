...
import CommercialInteriorEmployee from "./Employe/CommercialInterioremployee";
                ...
                <div style={{ backgroundColor: "white", width: "100%" }}>
                    ...
                    <div className="container mx-8" style={{ paddingTop: "10ch" }}>
                        ...
                        <Row style={{ marginTop: "10ch" }}>
                            ...
                            <Col md="5">
                                <div >
                                    <img src="/assets/images/Company-amico.svg" />
                                </div>
                            </Col>
                        </Row>
                        <Row style={{ marginTop: "20ch" }}>
                            <Col md="5">
                                <div >
                                    <img src="/assets/images/candy shop-amico.svg" />
                                </div>
                            </Col>
                            <Col md="6" style={{ padding: "5% 1% 0% 5%" }}>
                                <h1 style={{ fontSize: "30px", textAlign: "" }}>
                        ...
                        <Row style={{ marginTop: "10ch" }}>
                            ...
                            <Col md="5">
                                <div >
                                    <img src="/assets/images/Coffee shop-amico.svg" />
                                </div>
                            </Col>
                        </Row>
                    </div>
                    ...
                    <div className="container" style={{ marginTop: "10ch" }}>
                        ...
                        <div className="image-slider-container">
                            ...
                            >
                                ...
                                <div>
                                    <img src='/assets/images/Gallery/3d-rendering-business-meeting-working-room-office-building.jpg' alt="Image 1" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/3d-rendering-modern-loft-office-lounge-co-working-space.jpg' alt="Image 1" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/beautiful-shot-modern-style-open-space-office-interior.jpg' alt="Image 1" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/conference-room-interior-modern-office-with-white-walls-monitor.jpg' alt="Image 1" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/meeting-room-interior-modern-office-with-long-wooden-table-chairs-around-it.jpg' alt="Image 1" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/modern-architecture-clean-design-bright-lighting-comfortable-seating-indoors-generated-by-artificial-intelligence.jpg' alt="Image 1" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/modern-interior-design-office.jpg' alt="Image 1" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/modern-office-space-interior.jpg' alt="Image 1" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/room-interior-design.jpg' alt="Image 1" />
                                </div>
                            </Carousel>
                        </div>
                    </div>
