...
const CommercialInteriorEmployee = () => {
    ...
    useEffect(() => {
        fetch('http://127.0.0.1:8000/apiv1/user/Services/')
            ...
            .then(data => {
                const commercialInteriorServices = data.filter(service => service.Services === 'Commercial Interior');
...
export default CommercialInteriorEmployee;
