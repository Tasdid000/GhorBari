...
import ResidentialInteriorEmployee from "./Employe/ResidentialInterioremployee";
                ...
                <div style={{ backgroundColor: "white", width: "100%" }}>
                    ...
                    <div className="container mx-8" style={{ paddingTop: "10ch" }}>
                        <Row style={{ marginTop: "5ch" }}>
                            ...
                            <Col md="5">
                                <div>
                                    <img src="/assets/images/Interior design-amico.svg" />
                                </div>
                            </Col>
                        </Row>
                        <Row style={{ marginTop: "20ch" }}>
                            <Col md="5">
                                <div>
                                    <img src="/assets/images/Interior design-bro.svg" />
                                </div>
                            </Col>
                            <Col md="6" style={{ padding: "5% 1% 0% 5%" }}>
                                <h1 style={{ fontSize: "30px", textAlign: "" }}>
                    ...
                    <div className="container" style={{ marginTop: "10ch" }}>
                        ...
                        <div className="image-slider-container">
                            ...
                            >
                                ...
                                <div>
                                    <img src='/assets/images/residentialinterior2.jpg' alt="Image 2" />

                                </div>
                                <div>
                                    <img src='/assets/images/residentialinterior3.jpg' alt="Image 3" />
                                </div>
                                <div>
                                    <img src='/assets/images/residentialinterior4.jpg' alt="Image 4" />
                                </div>


                                <div>
                                    <img src='/assets/images/Gallery/3d-rendering-white-wood-living-room-near-bedroom-upstair.jpg' alt="Image 5" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/pexels-houzlook-com-3797991.jpg' alt="Image 6" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/pexels-jason-boyd-3209045.jpg' alt="Image 7" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/pexels-mark-1080721.jpg' alt="Image 8" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/pexels-pixabay-280232.jpg' alt="Image 9" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/pexels-pixabay-280239.jpg' alt="Image 10" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/pexels-vecislavas-popa-1571453.jpg' alt="Image 11" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/pexels-vecislavas-popa-1571459.jpg' alt="Image 12" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/pexels-vecislavas-popa-1743227.jpg' alt="Image 13" />
                                </div>
                                <div>
                                    <img src='/assets/images/Gallery/pexels-mike-bird-106936.jpg' alt="Image 14" />
                                </div>
                            </Carousel>
                        </div>
                    </div>
