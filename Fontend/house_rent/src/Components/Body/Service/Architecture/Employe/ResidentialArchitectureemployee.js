...
import './Architectureemployee.css';

const ResidentialArchitectureEmployee = () => {
    ...
    useEffect(() => {
        fetch('http://127.0.0.1:8000/apiv1/user/Services/')
            ...
            .then(data => {
                const commercialArchitectureServices = data.filter(service => service.Services === 'Residential Architecture');
                setServices(commercialArchitectureServices);
            })
            .catch(error => {
...
export default ResidentialArchitectureEmployee;
